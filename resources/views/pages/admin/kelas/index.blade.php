...
@section('title', 'Tahun Akademik Kelas Dosen P2K')
        ...
        var table = $('#tahun-akademik-table').DataTable({
            ...
            "columns": [{
                ...
                {"data": "kelas_count"},
                {
                    ...
                    "render": function(data, type, row) {
                        return `
                            <a href="{{ url('p2k/kelas') }}/${row.id}/show" class="btn btn-xs btn-primary" data-toggle="tooltip" data-placement="top" title="Lihat Kelas">
