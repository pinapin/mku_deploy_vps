...
@section('title', 'Tambah Soal - ' . $ujian->nama_ujian)
                    ...
                    <div class="card">
                        <div class="card-header">
                            ...
                            <div class="card-tools">
                                <a href="{{ route('master.soal.index.encrypted', \App\Services\UrlEncryptionService::encryptId($ujian->id)) }}" class="btn btn-default btn-sm">
                                    <i class="fas fa-arrow-left"></i> Kembali
                                </a>
                            </div>
                        </div>
                        <form action="{{ route('master.soal.store') }}" method="POST" id="soalForm">
                            @csrf
                            <div class="card-body">
                                @if ($errors->any())
                                ...
                                <div class="row">
                                    <div class="col-md-2">
                                        <div class="form-group">
                                            ...
                                            <input type="number"
                                                ...
                                                value="{{ old('nomor_soal', $lastNomor + 1) }}" placeholder="Nomor soal"
                                                min="1" required>
                                            @error('nomor_soal')
                                    ...
                                    <div class="col-md-10">
                                        <div class="form-group">
                                            <label for="tipe">Jenis Soal <span class="text-danger">*</span></label>
                                            <select class="form-control @error('tipe') is-invalid @enderror"
                                                id="tipe" name="tipe" required onchange="toggleJenisSoal()">
                                                <option value="">Pilih Jenis Soal</option>
                                                <option value="pilihan_ganda" {{ old('tipe') == 'pilihan_ganda' ? 'selected' : '' }}>
                                                    Pilihan Ganda</option>
                                                <option value="essay" {{ old('tipe') == 'essay' ? 'selected' : '' }}>
                                                    Essay</option>
                                            </select>
                                            @error('tipe')
                                                <span class="invalid-feedback" role="alert">{{ $message }}</span>
                                    ...
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            ...
                                            <textarea class="form-control @error('teks_soal') is-invalid @enderror" id="teks_soal" name="teks_soal"
                                                rows="4" placeholder="Masukkan pertanyaan" required>{{ old('teks_soal') }}</textarea>
                                            @error('teks_soal')
                                                <span class="invalid-feedback" role="alert">{{ $message }}</span>
                                            @enderror
                                        </div>
                                        ...
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                ...
                                                <textarea class="form-control @error('kunci_jawaban') is-invalid @enderror" id="kunci_jawaban" name="kunci_jawaban"
                                                    rows="3" placeholder="Masukkan kunci jawaban untuk soal essay">{{ old('kunci_jawaban') }}</textarea>
                                                @error('kunci_jawaban')
                                                    <span class="invalid-feedback" role="alert">{{ $message }}</span>
                                                @enderror
                                            </div>
                                ...
                                <div id="pilihanGandaSection" style="display: none;">
                                    ...
                                    <div id="pilihanContainer">
                                        <!-- Pilihan awal akan ditambahkan via JavaScript -->
                                    </div>
                            ...
                            <div class="card-footer">
                                ...
                                <a href="{{ route('master.soal.index.encrypted', \App\Services\UrlEncryptionService::encryptId($ujian->id)) }}" class="btn btn-default">
