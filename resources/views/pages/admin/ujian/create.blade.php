            ...
            <div class="row">
                <div class="col-12">
                    <div class="card">
                        ...
                        <form action="{{ route('master.ujian.store') }}" method="POST">
                            @csrf
                            <div class="card-body">
                                @if($errors->any())
                                    ...
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            ...
                                            <textarea class="form-control @error('deskripsi') is-invalid @enderror"
                                                ...
                                                placeholder="Masukkan deskripsi ujian (opsional)">{{ old('deskripsi') }}</textarea>
                                            @error('deskripsi')
                                                <span class="invalid-feedback" role="alert">{{ $message }}</span>
                                            @enderror
                                        </div>
                            ...
                            <div class="card-footer">
                                <button type="submit" class="btn btn-primary" data-toggle="tooltip" data-placement="top" title="Simpan Data Ujian">
