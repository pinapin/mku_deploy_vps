                                                                            ...
                                                                            <div class="text-center mt-3">
                                                                                        @if($kelompok['surat_pengantar'])
                                                                                            ...
                                                                                            <div class="d-flex flex-column align-items-center w-100">
                                                                                                <a href="{{ route('dosen.surat-pengantar.cetak', ['id' => encrypt($kelompok['surat_pengantar']['id'])]) }}" class="btn btn-sm btn-primary btn-hover w-100" target="_blank" data-toggle="tooltip" title="Lihat File">
                                                                                    ...
                                                                                    <div class="d-flex flex-column align-items-center w-100">
                                                                                        {{-- @if($kelompok['pks']['file_path']) --}}
                                                                                            <a href="{{ asset('storage/' . $kelompok['pks']['file_path']) }}" class="btn btn-sm btn-primary btn-hover w-100" target="_blank" data-toggle="tooltip" title="Lihat File PKS">
                                                                                                <i class="fas fa-file-pdf mr-1"></i> Lihat Dokumen PKS
                                                                                            </a>
                                                                                ...
                                                                                @if($hasLaporanAkhir)
                                                                                    ...
                                                                                    <div class="mt-2">
                                                                                        ...
                                                                                        @elseif($laporanToValidate)
                                                                                            <div class="d-flex flex-column align-items-center w-100">
                                                                                                <button class="btn btn-sm btn-success btn-hover validate-laporan w-100" data-id="{{ $laporanToValidate['laporan_akhir']['id'] }}" data-toggle="tooltip" title="Validasi Laporan">
                                                                                                    <i class="fas fa-check-circle mr-1"></i> Validasi Laporan
                                                                                                </button>
                                                                                            </div>
                                                                                        @endif
                                                                                    </div>
